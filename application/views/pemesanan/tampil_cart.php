...
<form action="<?php echo base_url() ?>pemesanan/ubah_cart" method="post" name="frmpemesanan" id="frmpemesanan" class="form-horizontal" enctype="multipart/form-data">
  <?php
  ...
  ?>
    ...
    <table class="table">
      ...
      <?php
      // Create form and send all values in "pemesanan/update_cart" function.
      $grand_total = 0;
      $i = 1;
      ...
      ?>
        ...
        <tr>
          ...
          <td colspan="4" align="right">
            ...
            <a href="<?php echo base_url() ?>pemesanan/check_out" class='btn btn-sm btn-primary'>Check Out</a>
        </tr>

    </table>
  <?php
  } else {
    echo "<h3>Anda masih belum memilih paket</h3>";
  }
  ?>
</form>
    ...
    <div class="modal-content">
      <form method="post" action="<?php echo base_url() ?>pemesanan/hapus/all">
        ...
        <div class="modal-body">
          Anda yakin mau mengosongkan pemesanan Cart?
